...
import fondoVacio from '../images/fondo-vacio.png';
...
<div className="w-full">
     ...
     <div className="relative w-full py-55 flex flex-col items-center justify-center overflow-hidden">
                ...
                <div className="relative z-10 flex flex-col md:flex-row gap-6 w-full max-w-3xl">
                    {/* Recuadro 1 */}
                    <div className="relative flex-1 h-64 md:h-32 rounded-xl overflow-hidden flex flex-col items-center justify-end w-full max-w-xs mx-auto md:max-w-none shadow-lg md:shadow-2xl">
                    ...
                    {/* Recuadro 2 */}
                    <div className="relative flex-1 h-64 md:h-32 rounded-xl overflow-hidden flex flex-col items-center justify-end md:mb-0 w-full max-w-xs mx-auto md:max-w-none shadow-lg md:shadow-2xl">
                ...
                <div className="relative z-10 w-full mt-6 h-26 md:h-48  rounded-xl overflow-hidden flex items-center justify-center w-full max-w-xs mx-auto md:max-w-3xl shadow-lg md:shadow-2xl">
                    <Image
                        ...
                        className="object-cover z-0 transition-transform duration-300 hover:scale-110 md:w-1/2 md:h-1/2"
                    />
                    <span className={`${robotoCondensed.className} uppercase text-white text-2xl md:text-5xl font-bold drop-shadow-2xl md:drop-shadow-xl mr-auto ml-6`}>
                            <a href="#" target="_blank" rel="noopener noreferrer" className="clavero-link">
                                estudiantil
                            </a>
                        </span>
